...
export default let dogBreedsList = [
  ...
  'boxer',         'brabancon',   'briard',          'buhund norwegian',
  'boston bulldog',  'english bulldog', 'french bulldog' ,    'staffordshire bullterrier', 'australian cattledog',       'cavapoo',
  'chihuahua',     'indian chippiparai', 'chow',            'clumber',
  'cockapoo',      'border collie',      'coonhound',       'cardigan corgi',
  'cotondetulear', 'dachshund',   'dalmatian',       'great dane',
...
"toy poodle", 'pug',             'puggle',
  ...
  'welsh spaniel',       'indian spitz',       'english springer',        'st bernard',
